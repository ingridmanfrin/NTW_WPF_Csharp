...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    => optionsBuilder.UseSqlServer("Server=DESKTOP-5REMAT9\\SQLSERVER2022;Database=Northwind;Trusted_Connection=True; Trust Server Certificate=true");
    //=> optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=Northwind;Trusted_Connection=True; Trust Server Certificate=true");
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            //entity.HasMany(d => d.CustomerCustomerDemos)//.WithMany(p => p.Customers)    ///mapeamento antigo...mapeamento que o EF fez errado com a tabela CustomerCustomerDemos
        ...
        modelBuilder.Entity<CustomerCustomerDemo>(entity =>     //mapeamos à mão
        {
            entity.HasKey(e => new { e.CustomerTypeId, e.CustomerId }).IsClustered(false);
            ...
            entity.HasOne(d => d.CustomerDemographic).WithMany(p => p.CustomerCustomerDemos)
